...
class BertPreprocessor(engine.BasePreprocessor):
    """
    Bert preprocessor helper.
    ...
    def __init__(self, tokenizer: BertTokenizer,
        ...
        self._left_fixedlength_unit = processor_units.BertFixedLengthUnit(
            self._fixed_length_left,
            cls_value=tokenizer.cls_token_id,
            sep_value=tokenizer.sep_token_id,
            pad_value=tokenizer.pad_token_id,
            pad_mode='post',
            truncate_mode='post'
        )
        self._right_fixedlength_unit = processor_units.BertFixedLengthUnit(
        ...
        # )
        self._default_units = [
            processor_units.BertTokenizeUnit(tokenizer),
    ...
    def fit(self, data_pack: DataPack, verbose: int = 1):
        ...
        vocab_unit = processor_units.BertVocabularyUnit()
        vocab_unit.fit(self.tokenizer.get_vocab())
